module Experiments.Raycast.Raycast02 exposing (Model, Module, Msg, init)
    ...
    let
        ...
        collisions =
            rays
                ...
                |> List.map (\( x, y ) -> Ball.draw <| Ball.create x y 3)
    in
    boundaries_ ++ rays_ ++ collisions
